...
def describe() -> ArchitectureDescription:
    ...
    return ArchitectureDescription(name='pix2pix', title='Pix2Pix', category='Generative', summary='Paired image-to-image translation with conditional GAN.', papers=papers)
