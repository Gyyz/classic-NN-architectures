...
def describe() -> ArchitectureDescription:
    ...
    return ArchitectureDescription(name='shufflenet', title='Shufflenet', category='Convolutional', summary='Channel shuffle for efficient group convolutions.', papers=papers)
