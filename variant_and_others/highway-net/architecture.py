"""
Highway Net — Highway Net overview.
...
def describe() -> ArchitectureDescription:
    ...
    return ArchitectureDescription(name='highway-net', title='Highway Net', category='Feedforward', summary='Highway Net overview.', papers=papers)
