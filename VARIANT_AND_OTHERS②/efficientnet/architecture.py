...
def describe() -> ArchitectureDescription:
    ...
    return ArchitectureDescription(name='efficientnet', title='Efficientnet', category='Convolutional', summary='Compound scaling of depth/width/resolution for efficiency.', papers=papers)
